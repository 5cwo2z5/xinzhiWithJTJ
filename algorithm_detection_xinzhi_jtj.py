...
def xinzhi_process_jtj(posn):
    ...
    RADIAN = update_radian(posn[b'5'], posn[b'6'])

    
    cv2.circle(img_dbg, posn[b'5'], 5, (255, 0, 0), -1)
    cv2.circle(img_dbg, posn[b'6'], 5, (255, 0, 0), -1)
    cv2.circle(img_dbg, (int((posn[b'6'][0]+posn[b'5'][0])/2), int((posn[b'6'][1]+posn[b'5'][1])/2)), 5, (255, 0, 0), -1)
    # cv2.line(img_dbg, , (255, 0, 0))
    l_pos = get_position(img_path, relative_position_photo, SCALE, RADIAN, posn[b'5'])
    if len(l_pos) == 17:
